...
tokenizer = nltk.data.load('punkt/hungarian.pickle')
print(tokenizer.tokenize(hu_text.strip()))

text = "Ай да А.С. Пушкин!"
tokenizer = nltk.data.load('punkt/russian.pickle')
print(tokenizer.tokenize(text.strip()))



text = "Ой! Я що це робиться, люди! І.В. Франко"
tokenizer = nltk.data.load('punkt/ukrainian.pickle')
print(tokenizer.tokenize(text.strip()))